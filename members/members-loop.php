...
<?php if ( bp_has_members( bp_ajax_querystring( 'members' ) ) ) : ?>
	...
	<?php while ( bp_members() ) : bp_the_member(); ?>
		...
		<?php /*if (bp_get_member_profile_data( 'field=Would you like to be added to the public blogger directory?' )) :*/ ?>
		<li class="item-li">
				...
				<div class="item-content clearfix">
					...
					<header class="item-header">
						...
						<div class="item-avatar">
							<a href="<?php echo bp_get_member_profile_data( 'field=I blog at' ) ?>" target="_blank"> <?php bp_member_avatar('type=full&width=140&height=140'); ?> </a>	
						</div>
