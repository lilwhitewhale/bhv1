...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p><?php _e( 'Your avatar will be used on your profile and throughout the site. If there is a <a href="http://gravatar.com" target="_blank">Gravatar</a> associated with your account email we will use that, or you can upload an image from your computer.', 'buddypress') ?></p>

	<form action="" method="post" id="avatar-upload-form" enctype="multipart/form-data">

		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>

			<p><?php _e( 'Click below to select a JPG, GIF or PNG format photo from your computer, then click \'Upload Image\' to proceed.', 'buddypress' ) ?></p>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				<p><?php _e( "If you'd like to delete your current avatar, please click on the following link: ", 'buddypress' ) ?></p>
