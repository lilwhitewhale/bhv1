...
<div ID="headerWrapper" <?php echo $bgStyle; ?>>
	<div class="inner-1" <?php echo $bg_glow; ?>>
		<div class="inner-2">
			...
			?>
			<header>
				<div id="MainHeader" class="pageWrapper clearfix dotsbottom">

					<div class="mainmenu dotsleft" id="leftmenu">
						<ul>
							<li><a href="/our-story">Our Story</a></li>
							<li><a href="/forum/chit-chat">Chit Chat</a></li>
							<li><a href="/forum/project-boards">Project Boards</a></li>
						</ul>
					</div>
					
					<div class="mainmenu dotsright" id="rightmenu">
						<ul>
							<li><a href="/members">Find Local Bloggers</a></li>
