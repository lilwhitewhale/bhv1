		...
		<td class="bbp-topic-info">
			...
			<div class="bbp-topic-meta-content">
				...
				<div class="bbp-topic-meta-counts">
					<span class="bbp-topic-reply-label"><?php bbp_show_lead_topic() ? bbp_topic_reply_count() : bbp_topic_post_count(); ?> <?php bbp_show_lead_topic() ? _e( 'Replies', 'bbpress' ) : _e( 'Posts', 'bbpress' ); ?></span>
					<div class="clear"></div>
				</div>
			...
			<p class="bbp-topic-meta">
				...
				<span class="bbp-topic-meta">
					...
					<span class="bbp-topic-freshness-author"><?php printf( __( 'Latest reply by:%1$s', 'bbpress' ), bbp_get_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'size' => 14 ) ) ); ?></span>
